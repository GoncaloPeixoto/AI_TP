...
class AStar:
    ...
    def run(self):
        ...
        for waypoint in waypoints:
            ...
            self.reset_search()
            if not self.find_path(current_start):  # Fix: Handle cases where no path is found
    ...
    def reset_search(self):
        ...
        self.g = {}
        self.h = {}
        self.path = []  # Fix: Reset the path properly
    ...
    def find_path(self, current_start):
        ...
        while self.OPEN:
            ...
            if current_node == self.s_goal:
                ...
                return True  # Fix: Return True when the goal is reached
        ...
        return False  # Fix: Return False if no path is found

    def reconstruct_path(self):
        current = self.s_goal
        path = []
        while current in self.PARENT:  # Fix: Check if current has a parent to prevent infinite loops
            path.append(current)
